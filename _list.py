...
class Window(QtWidgets.QMainWindow):
    ...
    def loadStudents(self):
        self.ui.listItems.addItems(["Ahmet", "Gökhan", "Elif"])
    ...
    def editStudent(self):
        ...
        if item is not None:
            text, ok = QInputDialog.getText(self, "Edit Student", "Studen Name", QLineEdit.Normal, item.text())
    ...
    def removeStudent(self):
        ...
        q = QMessageBox.question(self, "Remove Student",
                                 "Do you want to remove student:" + item.text(), QMessageBox.Yes | QMessageBox.No)
